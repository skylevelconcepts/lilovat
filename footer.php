                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-about mt-40">
                            ...
                            <p>Lilovat solar Technology is a Nigeria based solar energy provider, We provide energy solution to people all over west Africa.</p>
                            <ul class="mt-20">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="footer-link mt-40">
                            ...
                            <ul>
                                ...
                                <li><a href="blog.php"><i class="fa fa-angle-right"></i>Projects</a></li>
                                <li><a href="events.php"><i class="fa fa-angle-right"></i>shop</a></li>
                            </ul>
                            <ul>
                                <li><a href="#"><i class="fa fa-angle-right"></i>Gallery</a></li>
                                <li><a href="shop.php"><i class="fa fa-angle-right"></i>Shop</a></li>
                                <li><a href="teachers.php"><i class="fa fa-angle-right"></i>Installation</a></li>
                                <li><a href="#"><i class="fa fa-angle-right"></i>Testimonials</a></li>
                                <li><a href="contact.php"><i class="fa fa-angle-right"></i>Login</a></li>
                            </ul>
                        </div> <!-- footer link -->
                    </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="copyright text-md-left text-center pt-15">
                            <p>&copy; 2020 Lilovat Solar Technology. </p>
                        </div>
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
