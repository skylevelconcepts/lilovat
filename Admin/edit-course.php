           ...
           while($row = $qry->fetch_assoc()){
             ...
             echo $row['price']; } ?>" name="price"  required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="compose-textarea" class="form-control" name="overview" style="height: 500px" required><?php
$sql = "SELECT * FROM courses where uniqueid='$id'";
$qry = $conn->query($sql);
           while($row = $qry->fetch_assoc()){
             ...
             echo $row['overview']; } ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="compose-textarea" class="form-control" name="courseproject" style="height: 500px" required><?php
$sql = "SELECT * FROM courses where uniqueid='$id'";
$qry = $conn->query($sql);
           while($row = $qry->fetch_assoc()){
             ...
             echo $row['courseproject']; } ?></textarea>
                ...
                <div class="form-group">
                    <label>Review *</label>
                    <textarea class="compose-textarea" class="form-control" name="review" style="height: 500px" required><?php
$sql = "SELECT * FROM courses where uniqueid='$id'";
$qry = $conn->query($sql);
           while($row = $qry->fetch_assoc()){
...
$qry = $conn->query($sql);
           while($row = $qry->fetch_assoc()){
             ...
             echo $row['teacher']; } ?>" name="teacher"  required>
...
$qry = $conn->query($sql);
           while($row = $qry->fetch_assoc()){
             ...
             echo $row['category']; } ?>" name="category"  required>
...
$qry = $conn->query($sql);
           while($row = $qry->fetch_assoc()){
             ...
             echo $row['duration']; } ?>" name="duration"  required>
...
$qry = $conn->query($sql);
           while($row = $qry->fetch_assoc()){
             ...
             echo $row['hoursperday']; } ?>" name="hoursperday"  required>
...
$qry = $conn->query($sql);
           while($row = $qry->fetch_assoc()){
             ...
             echo $row['lectures']; } ?>" name="lectures"  required>
...
$qry = $conn->query($sql);
           while($row = $qry->fetch_assoc()){
             ...
             echo $row['studentstrained']; } ?>" name="studentstrained"  required>
            ...
            <div class="card card-default">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="compose-textarea"  name="instructorsdescription'.$row['adid'].'" style="height: 500px" required>'.$row['description'].'</textarea><input  type="hidden" value="'.$row['name'].'"  name="instructors[]"  required>
                </div></div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Name </label> *
                    <input class="form-control"  type="text" value="'.$row['name'].'"   name="instructorsname'.$row['adid'].'"  required>
                </div></div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control"  type="text" value="'.$row['job'].'"  name="instructorsjob'.$row['adid'].'"   required>
                </div></div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Facebook </label> (e.g https://facebook.com/username)*
                    <input class="form-control"  type="text" value="'.$row['facebook'].'" name="instructorsfacebook'.$row['adid'].'"    required>
                </div></div><div class="col-md-6">
                  <div class="form-group">
                    <label>Instagram </label>(e.g https://instagram.com/username) *
                    <input class="form-control"  type="text" value="'.$row['instagram'].'"  name="instructorsinstagram'.$row['adid'].'"   required>
                </div></div><div class="col-md-6">
                  <div class="form-group">
                    <label>Twitter </label>(e.g https://twitter.com/username)*
                    <input  class="form-control" type="text" value="'.$row['twitter'].'"  name="instructorstwitter'.$row['adid'].'"   required>
                </div></div>
                <div class="col-sm-6">
                      <ul class=" d-flex ">
    ...
    echo '  <div class="col-md-12">
            <div class="card card-default">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Description *</label>
                    <textarea class="compose-textarea" class="form-control" name="curriculumdescription'.$row['adid'].'" style="height: 500px" required>'.$row['description'].'</textarea><input  type="hidden" value="'.$row['adid'].'"  name="curricullum[]"  required>
                </div>
                  ...
                  <div class="form-group">
                    <label>Name *</label>
                    <input  class="form-control" type="text" value="'.$row['name'].'" name="curriculumname'.$row['adid'].'" required>
                </div>
