...
?>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      <form action="add-instructor-2.php" method="post">
          ...
          <div class="col-md-12">
              <div class="form-group">
                  ...
                  <div class="select2-purple">
                      <input name="instructorsi" class="form-control" id="choices-text-preset-values" type="text" placeholder="Type to add..." required/>
